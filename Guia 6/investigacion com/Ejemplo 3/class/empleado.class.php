...
calculados.</p>";
 ...
 function obtenerSalarioNeto($nombre, $apellido, $salario, $horasextras,$pagoxhoraextra=0.0,$descPrestamo=0.0){
 $this->nombre = $nombre;
 ...
 if($this->descPrestamo>0){
    $this->sueldoNominal = $this->sueldoNominal - $this->descPrestamo;
 }
 ...
 $this->sueldoNominal = $salario;
 $this->sueldoLiquido = $this->sueldoNominal + $this->pagoxhoraextra - ($this->isss + $this->afp + $this->renta+$this->descPrestamo);
...
if($this->descPrestamo>0){
   ...
   $tabla.="<td>$ " . number_format($this->descPrestamo, 2, '.', ',') . "</td></tr>";
}
 ...
 $tabla .= "<td>$ " . number_format($this->isss + $this->afp + $this->renta+$this->descPrestamo, 2, '.',
',') . "</td></tr>";
