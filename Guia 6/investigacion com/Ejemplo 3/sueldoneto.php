...
<body class='container'>
    ...
    if (isset($_POST['enviar'])) {
        if (isset($_POST['enviar'])) {
            ...
            $descPrestamo = (isset($_POST['descPrestamo'])) ?
                floatval($_POST['descPrestamo']) : 0.0;
            //Creando instancias de la clase empleado
            $empleado1 = new empleado();
            $empleado1->obtenerSalarioNeto($name, $apellido, $sueldo, $numHorasExtras, $pagohoraextra,$descPrestamo);
        }
    } else {
    ?>
            ...
            <article>
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="desPrestamo">Descuento de prestmos(si aplica):</label>
                            <input type="text" name="descPrestamo" id="descPrestamo" size="4"
                                maxlength="6" class="inputField form-control" /><br />
                        </div>
